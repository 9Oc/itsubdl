...
python -m itsubdl.cli 1228246 2>&1 | tee "$TEST_DIR/debug_tmdb.log" || true

echo ""
echo "=== Running Test Case 2: Direct Apple TV URL ==="
python -m itsubdl.cli "https://tv.apple.com/us/movie/five-nights-at-freddys-2/umc.cmc.4ers7f6sg3ia9ru4qhisv93yx" 2>&1 | tee "$TEST_DIR/debug_url.log" || true
